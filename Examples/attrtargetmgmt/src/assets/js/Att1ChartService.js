...
export let getChartData = function( engrTable ) {
    ...
    for ( let [ key, value ] of chartSeriesData ) {
        ...
        seriesDataForChart.push( {
            seriesName: engrTable.propertyDisplayNames ? engrTable.propertyDisplayNames.Measurement : getLocalizedText( 'Measurement' ) + ' ' + seriesName,
            keyValueDataForChart: value.Measurement,
            chartPointsConfig: 'colorOverrides'
        } );
        if( engrTable.valueTable.showGoal ) {
            seriesDataForChart.push( {
                seriesName: engrTable.propertyDisplayNames ? engrTable.propertyDisplayNames.Goal : getLocalizedText( 'Goal' ) + ' ' + seriesName,
        ...
        if( engrTable.valueTable.showRange ) {
            seriesDataForChart.push( {
                seriesName: engrTable.propertyDisplayNames ? engrTable.propertyDisplayNames.Min : getLocalizedText( 'Min' ) + ' ' + seriesName,
                keyValueDataForChart: value.Min,
                chartPointsConfig: 'colorOverrides'
            } );
            seriesDataForChart.push( {
                seriesName: engrTable.propertyDisplayNames ? engrTable.propertyDisplayNames.Max : getLocalizedText( 'Max' ) + ' ' + seriesName,
