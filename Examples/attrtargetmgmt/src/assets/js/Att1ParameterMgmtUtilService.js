 ...
 */
export let getImportOptionsForComplexData = function( engrTableCtx ) {
...
export let getTemplateRequestPref = function( ctx, invoked, paramTableCtx, commandContext ) {
    ...
    var context = paramTableCtx && paramTableCtx.selectedUnderlyingObjects && paramTableCtx.selectedUnderlyingObjects.length !== 0 ? paramTableCtx.selectedUnderlyingObjects : ctx.mselected;
